...
public class ProductOrderReviewImagesDTO {
	...
	public ProductOrderReviewImagesDTO(int order_id, String userid, int p_id, int total_price, String delivery_address,
			String delivery_loc, String delivery_req, String order_date, int order_quantity, String p_name,
			String p_content, int c_id, int p_cost_price, int p_selling_price, int p_discount, String p_created,
			int p_stock, int review_id, String review_title, String review_content, String review_rate,
			String review_img, String review_create) {
		super();
	...
	public String toString() {
		return "ProductOrderReviewImagesDTO [order_id=" + order_id + ", userid=" + userid + ", p_id=" + p_id
				...
				+ delivery_loc + ", delivery_req=" + delivery_req + ", order_date=" + order_date + ", order_quantity="
				+ order_quantity + ", p_name=" + p_name + ", p_content=" + p_content + ", c_id=" + c_id

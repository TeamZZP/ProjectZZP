    ...
    <div class="row" style="margin-top: -30px;">
      ...
      <div class="col-5 text-start">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="StoreUIServlet" class="nav-link p-0 text-muted"><span class="headercss">스토어</span></a></li>
...
<p>
제 1 조 (목적)
이 약관은 ZZP(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
</p>
<p>
제 2 조 (약관의 효력 및 변경)
...
<p>
1 개인정보의 처리 목적<br>
① <ZZP>은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.<br>
...
① <ZZP>은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유·이용기간 또는 법령에 따른 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br>
...
정보주체는 <ZZP>에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.<br>
1. 개인정보 열람요구<br>
...
① <ZZP>은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br>

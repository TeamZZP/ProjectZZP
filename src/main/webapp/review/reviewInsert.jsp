	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#reviewInsert").click(function () {
				...
				var ORDER_ID = $("#reviewInsert").attr("data-orderID");
				var REVIEW_IMG = $("#REVIEW_IMG").val();
				console.log(REVIEW_IMG);
				$("#reviewForm").attr("action", "reviewUploadServlet?USERID="+userid+"&operate="+operate+"&ORDER_ID="+ORDER_ID);
			}); //
...
<form action="" id="reviewForm" enctype="multipart/form-data" method="post">
		...
		%>
			...
			<tr>
				...
				<td style="text-align: right;">
					<button id="reviewInsert" data-userid="<%=userid %>" data-operate="<%=operate %>" data-orderID="<%=ORDER_ID%>" class="btn btn-success">등록</button>
